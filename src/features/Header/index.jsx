      ...
      <div className="navigation" ref={navigationRef} 
        ...
        <div className="navigation__item">
          ...
          {/* <div className="">
            ...
            <div className="">
              <Link to="/?province_code=1">Lớp học tại Hà Nội</Link>
              <Link to="/?province_code=79">Lớp học tại TP.Hồ Chí Minh</Link>
              <Link to="/?province_code=48">Lớp học tại Đà Nẵng</Link>
              <Link to="/?province_code=31">Lớp học tại Hải Phòng</Link>
            </div>
          </div> */}
        </div>
        <div className="navigation__item">
